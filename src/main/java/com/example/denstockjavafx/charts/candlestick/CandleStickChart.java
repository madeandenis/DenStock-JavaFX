...
public class CandleStickChart extends XYChart<String, Number> {
     ...
     */
    public CandleStickChart(String title, List<BarData> bars, SimpleDateFormat sdf) {
        this(title, bars, Integer.MAX_VALUE, sdf);
    }
     ...
     */
    public CandleStickChart(String title, List<BarData> bars, int maxBarsToDisplay, SimpleDateFormat sdf) {
        this(title, new CategoryAxis(), new NumberAxis(), bars, maxBarsToDisplay, sdf);
    }
     ...
     */
    public CandleStickChart(String title, CategoryAxis xAxis, NumberAxis yAxis, List<BarData> bars, int maxBarsToDisplay, SimpleDateFormat sdf) {
        super(xAxis, yAxis);
        this.xAxis = xAxis;
        this.yAxis = yAxis;
        ...
        setTitle(title);
        setAnimated(true);
        getStylesheets().add(Objects.requireNonNull(getClass().getResource("/css/candleStickChartStyle.css")).toExternalForm());
